...
Route::group(['prefix' => 'api/v1'], function () {
     ...
     * Post assessment mcq
     */
    Route::post('assessment/mcq', 'API\UserController@storeMcqAssessment');
    /**
     ...
     * Get all clients 
     */
    Route::get('experts/clients/all','API\UserController@getClients');
    /**
    ...
    /**
     * Seed arabic mcq assessment
     */
    Route::post('seed/decesion/ar','DbSeeders@seedDecisionArabic');
});
